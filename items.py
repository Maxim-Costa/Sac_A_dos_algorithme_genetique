"""
list hasard items minecraft
import requests
from bs4 import BeautifulSoup

url = "https://minecraft-ids.grahamedgecombe.com/"
html = requests.request("GET", url, headers={},data={}).text.encode('utf8'))
soup = BeautifulSoup(html)
ItemName = soup.find_all("span",class_="name")
for i in range(len(ItemName)):
    ItemName[i] = "-".join(ItemName[i].string.split(" "))
"""
ItemName = ["Air",
            "Stone",
            "Granite",
